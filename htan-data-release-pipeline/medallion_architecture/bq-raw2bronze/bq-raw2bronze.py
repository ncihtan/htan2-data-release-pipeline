...
Configurations:
    ...
    'medallion_architecture/bq-raw2bronze/config.json'
    and 'medallion_architecture/bq-raw2bronze/schema.json'
...
bq_schema = json.load(open('medallion_architecture/bq-raw2bronze/schema.json'))
