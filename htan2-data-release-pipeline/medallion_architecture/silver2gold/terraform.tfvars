...
region = "us-east1"
image_url = "us-docker.pkg.dev/htan2-dcc/gcr.io/silver2gold:latest"
...
job_description = "Update gold metadata pulled using silver data for indexing in Google Bigquery (htan2-dcc)."
job_schedule = "0 3 * * *"
